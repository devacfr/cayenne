...
@Documented
public @interface CayenneConfiguration {

    /**
     * Contains the location of Cayenne runtime configuration (must not be
     * {@code null} or empty).
     *
     * @return Returns a String representing the location of Cayenne runtime
     *         configuration.
     */
    String value();
