...
public interface TransactionOperations {
     ...
     * <p>The Transaction is executed with default definition (see
     * {@link TransactionDefinition#DEFAULT}))
     */
    //TODO [devacfr] waiting java8 to declare default implementation 
     ...
     * @return
     */
    <T> T performInTransaction(TransactionDefinition definition, TransactionalOperation<T> op);
}
